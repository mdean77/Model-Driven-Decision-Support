...
public class GlucosePackageImpl extends EPackageImpl implements GlucosePackage {
	 ...
	 * @generated
	 */
	public EOperation getPatient__GetBirthdateString() {
	 ...
	 * @generated
	 */
	public EOperation getPatient__GetTodayAgeYears() {
	 ...
	 * @generated
	 */
	public EOperation getPatient__GetTodayAgeDays() {
	...
	public void createPackageContents() {
		...
		createEOperation(patientEClass, PATIENT___GET_BIRTHDATE_STRING);
		createEOperation(patientEClass, PATIENT___GET_TODAY_AGE_YEARS);
		createEOperation(patientEClass, PATIENT___GET_TODAY_AGE_DAYS);
	...
	public void initializePackageContents() {
		...
		initEOperation(getPatient__GetBirthdateString(), ecorePackage.getEString(), "getBirthdateString", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getPatient__GetTodayAgeYears(), ecorePackage.getEInt(), "getTodayAgeYears", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEOperation(getPatient__GetTodayAgeDays(), ecorePackage.getEInt(), "getTodayAgeDays", 0, 1, IS_UNIQUE, IS_ORDERED);

		EOperation op = initEOperation(getPatient__GetDeltaAgeYears__Calendar(), ecorePackage.getEInt(), "getDeltaAgeYears", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getcalendar(), "date", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getPatient__GetDeltaAgeDays__Calendar(), ecorePackage.getEInt(), "getDeltaAgeDays", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getcalendar(), "date", 0, 1, IS_UNIQUE, IS_ORDERED);
