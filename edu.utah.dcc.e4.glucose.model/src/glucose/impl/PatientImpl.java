...
public class PatientImpl extends PersonImpl implements Patient {
	 ...
	 * @generated
	 */
	public int getDeltaAgeYears(final Calendar date) {
	 ...
	 * @generated
	 */
	public int getDeltaAgeDays(final Calendar date) {
		long millisBetween = Math.abs(getBirthdate().getTimeInMillis()
			- date.getTimeInMillis());
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GlucosePackage.PATIENT___GET_BIRTHDATE_STRING:
				return getBirthdateString();
			case GlucosePackage.PATIENT___GET_TODAY_AGE_YEARS:
				return getTodayAgeYears();
			case GlucosePackage.PATIENT___GET_TODAY_AGE_DAYS:
				return getTodayAgeDays();
			case GlucosePackage.PATIENT___GET_DELTA_AGE_YEARS__CALENDAR:
				return getDeltaAgeYears((Calendar)arguments.get(0));
			case GlucosePackage.PATIENT___GET_DELTA_AGE_DAYS__CALENDAR:
