...
public interface GlucosePackage extends EPackage {
	...
	/**
	 * The operation id for the '<em>Get Birthdate String</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PATIENT___GET_BIRTHDATE_STRING = PERSON_OPERATION_COUNT + 0;

	/**
	 * The operation id for the '<em>Get Today Age Years</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PATIENT___GET_TODAY_AGE_YEARS = PERSON_OPERATION_COUNT + 1;

	/**
	 * The operation id for the '<em>Get Today Age Days</em>' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int PATIENT___GET_TODAY_AGE_DAYS = PERSON_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int PATIENT___GET_DELTA_AGE_YEARS__CALENDAR = PERSON_OPERATION_COUNT + 3;
	 ...
	 * @ordered
	 */
	int PATIENT___GET_DELTA_AGE_DAYS__CALENDAR = PERSON_OPERATION_COUNT + 4;
	 ...
	 * @ordered
	 */
	int GLUCOSE_DECISION___ADVISE__STRING = CLINICAL_DECISION___ADVISE__STRING;
	 ...
	 * @ordered
	 */
	int GLUCOSE_DECISION_OPERATION_COUNT = CLINICAL_DECISION_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the '{@link glucose.Person#getName() <em>Get Name</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the '{@link glucose.Patient#getBirthdateString() <em>Get Birthdate String</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Birthdate String</em>' operation.
	 * @see glucose.Patient#getBirthdateString()
	 * @generated
	 */
	EOperation getPatient__GetBirthdateString();

	/**
	 * Returns the meta object for the '{@link glucose.Patient#getTodayAgeYears() <em>Get Today Age Years</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Today Age Years</em>' operation.
	 * @see glucose.Patient#getTodayAgeYears()
	 * @generated
	 */
	EOperation getPatient__GetTodayAgeYears();

	/**
	 * Returns the meta object for the '{@link glucose.Patient#getTodayAgeDays() <em>Get Today Age Days</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Today Age Days</em>' operation.
	 * @see glucose.Patient#getTodayAgeDays()
	 * @generated
	 */
	EOperation getPatient__GetTodayAgeDays();

	/**
	 * Returns the meta object for the '{@link glucose.Patient#getDeltaAgeYears(java.util.Calendar) <em>Get Delta Age Years</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Delta Age Years</em>' operation.
	 * @see glucose.Patient#getDeltaAgeYears(java.util.Calendar)
	 * @generated
	 */
	EOperation getPatient__GetDeltaAgeYears__Calendar();

	/**
	 * Returns the meta object for the '{@link glucose.Patient#getDeltaAgeDays(java.util.Calendar) <em>Get Delta Age Days</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Delta Age Days</em>' operation.
	 * @see glucose.Patient#getDeltaAgeDays(java.util.Calendar)
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the '{@link glucose.ClinicalDecision#advise(java.lang.String) <em>Advise</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Advise</em>' operation.
	 * @see glucose.ClinicalDecision#advise(java.lang.String)
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Get Birthdate String</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PATIENT___GET_BIRTHDATE_STRING = eINSTANCE.getPatient__GetBirthdateString();

		/**
		 * The meta object literal for the '<em><b>Get Today Age Years</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PATIENT___GET_TODAY_AGE_YEARS = eINSTANCE.getPatient__GetTodayAgeYears();

		/**
		 * The meta object literal for the '<em><b>Get Today Age Days</b></em>' operation.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EOperation PATIENT___GET_TODAY_AGE_DAYS = eINSTANCE.getPatient__GetTodayAgeDays();
