...
/**
 * This is the item provider adapter for a {@link glucose.IntensiveCareUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntensiveCareUnitItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GlucosePackage.Literals.INTENSIVE_CARE_UNIT__PATIENTS);
			childrenFeatures.add(GlucosePackage.Literals.INTENSIVE_CARE_UNIT__USERS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_IntensiveCareUnit_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GlucosePackage.Literals.INTENSIVE_CARE_UNIT__PATIENTS,
				 GlucoseFactory.eINSTANCE.createPatient()));

		newChildDescriptors.add
			(createChildParameter
				(GlucosePackage.Literals.INTENSIVE_CARE_UNIT__USERS,
				 GlucoseFactory.eINSTANCE.createUser()));
	}
