 ...
 * <ul>
 *   <li>{@link application.impl.UserImpl#getAccountRights <em>Account Rights</em>}</li>
 *   <li>{@link application.impl.UserImpl#getAccountName <em>Account Name</em>}</li>
 *   <li>{@link application.impl.UserImpl#getPasswordDigest <em>Password Digest</em>}</li>
 *   <li>{@link application.impl.UserImpl#getCreatedBy <em>Created By</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserImpl extends PersonImpl implements User
{
  ...
  public void setAccountRights(AccessType newAccountRights)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.USER__ACCOUNT_RIGHTS, oldAccountRights, accountRights));
  }
  ...
  public void setAccountName(String newAccountName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.USER__ACCOUNT_NAME, oldAccountName, accountName));
  }
  ...
  public void setPasswordDigest(String newPasswordDigest)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.USER__PASSWORD_DIGEST, oldPasswordDigest, passwordDigest));
  }
  ...
  public User getCreatedBy()
  {
    if (createdBy != null && createdBy.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ApplicationPackage.USER__CREATED_BY, oldCreatedBy, createdBy));
      }
    }
    return createdBy;
  }
  ...
  public void setCreatedBy(User newCreatedBy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.USER__CREATED_BY, oldCreatedBy, createdBy));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case ApplicationPackage.USER__CREATED_BY:
